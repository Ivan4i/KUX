#!/bin/bash
# ==============================================================================
# VS Code Launcher for Claude Code Account 1
# ==============================================================================
...
ENV_FILE="$MCP_KIT_DIR/.env.local.acc1"
if [[ -f "$ENV_FILE" ]]; then
...
cd "$PROJECT_ROOT"
code . --user-data-dir ~/.vscode-claude/acc1 --extensions-dir ~/.vscode-claude/acc1-exts
