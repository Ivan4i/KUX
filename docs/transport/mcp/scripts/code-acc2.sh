#!/bin/bash
# ==============================================================================
# VS Code Launcher for Claude Code Account 2
# ==============================================================================
...
ENV_FILE="$MCP_KIT_DIR/.env.local.acc2"
if [[ -f "$ENV_FILE" ]]; then
...
cd "$PROJECT_ROOT"
code . --user-data-dir ~/.vscode-claude/acc2 --extensions-dir ~/.vscode-claude/acc2-exts
