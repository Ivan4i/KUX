#!/bin/bash
# ==============================================================================
# VS Code Launcher for Claude Code Account 3
# ==============================================================================
...
ENV_FILE="$MCP_KIT_DIR/.env.local.acc3"
if [[ -f "$ENV_FILE" ]]; then
...
cd "$PROJECT_ROOT"
code . --user-data-dir ~/.vscode-claude/acc3 --extensions-dir ~/.vscode-claude/acc3-exts
